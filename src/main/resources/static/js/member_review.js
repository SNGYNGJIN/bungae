document.addEventListener('DOMContentLoaded', function() {
    ...
    const goReviewBtn = document.getElementById('go_review');
    const usersContainer = document.getElementById('usersContainer');
    const currentId = sessionStorage.getItem('loggedInUserId');
    const submitReviewBtn = document.getElementById('submitReview'); // 리뷰 최종 등록 버튼 ID
    ...
    const bungaeId = getRoomIdFromUrl();
